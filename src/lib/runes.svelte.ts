...
export const reusableStateRune = <StoredValue>(initialValue: StoredValue): Valuable<StoredValue> => {
...
// https://dev.to/jdgamble555/using-sharable-runes-with-typescript-in-svelte5-5hcp
export const useSharedStateRune = <StoredValue>(context: string, initialValue?: StoredValue) => {
